...
def initializeParameterFile():
    ...
    param['fractionnalR0'        ] = [0.1,0.2,0.1,0.2,0.1]                                            # Cn2 profile
    param['windSpeed'            ] = [15,10,20,30,10]                                           # wind speed of the different layers in [m.s-1]
    ...
    param['magnitude'            ] = 14                                             # magnitude of the guide star
